...
export default function TasksPage({ onBack, userId }: TasksPageProps) {
  ...
  return (
    <div className="relative mx-auto max-w-[402px] bg-background">
      ...
      {/* Title */}
      <h1 className="mt-md text-center font-serif text-display leading-display tracking-[-0.3px] text-text-strong">
        Tasks
      </h1>
          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                className="relative shrink-0 rounded-full px-[16px] py-[7px] text-secondary leading-secondary outline-none transition-colors duration-200"
              >
                {isActive && (
                  <motion.div
                    layoutId="active-tab"
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {tasks.length === 0 ? (
            <p className="py-5xl text-center text-secondary leading-secondary text-text-tertiary">
